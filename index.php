...
<head>
  ...
  <title>Home - Minimal Photography Wahyu</title>
...
<body class="home2">
  ...
  <div class="slider-container" style="margin-top: 50px;">
    <div>
      ...
      <div class="slider-post slider-item-box">
        <div class="slider-img" style="background-image:url('assets/images/home/slider-2.jpg');"></div>
        <!-- <div class="slider-caption">
          <h1>Welcome, I am Rick Smith! <br>Traveler</h1>
        </div> -->
      </div>
    </div>
  </div>
  ...
  <footer>
    <div class="container">
      <div>
        <h5>JANUARI 2020</h5>
        <div>I love to capture beautiful and emotional moments, that tell a unique story.
          Take a look at my portfolio and don't hesitate to contact me.</div>
      </div>
